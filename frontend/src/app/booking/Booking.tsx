...
export default function BookingPage() {
  ...
  useEffect(() => {
    ...
    const newOpen = Array.from(
      { length: numberOfGuests },
      (_, i) => guestOpen[i] ?? false
    );

    const servicesChanged = !arraysEqual2D(newServices, guestServices);
    const openChanged =
      newOpen.length !== guestOpen.length ||
      newOpen.some((v, i) => v !== (guestOpen[i] ?? false));
  ...
  useEffect(() => {
    if (
      ...
      if (
        selectedTreatment &&
        (!guestServices[0] || guestServices[0].length === 0)
      ) {
  ...
  console.log("Dữ liệu gửi đi:", JSON.stringify(orderPayload, null, 2)); 
                  ...
                  >
                    <ListItem disableGutters>
                      <ListItemText
                        ...
                        secondary={
                          formatDate(bookingData.date) || "Not selected"
                        }
              ...
              >
                ...
                <Stack spacing={3}>
                  ...
                  <Stack direction={{ xs: "column", sm: "row" }} spacing={3}>
                    <Box
                      sx={{ position: "relative", flex: 1, borderRadius: 0 }}
                    >
                      ...
                      >
                        <ClickAwayListener
                          onClickAway={() => setShowDialPicker(false)}
                        >
                          <Paper
                            elevation={8}
                            sx={{
                          ...
                          >
                            ...
                            {/* Search Box */}
                            <Box
                              sx={{ p: 2, borderBottom: "1px solid #9e2265" }}
                            >
                              <TextField
                                fullWidth
                                size="small"
