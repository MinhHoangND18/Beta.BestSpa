...
export default function HomePage() {
  ...
  >({
    ...
    queryFn: () =>
      getServices({ limit: 10, status: "active" as ServiceStatus }),
    ...
    <LocalizationProvider dateAdapter={AdapterDateFns}>
      <Box sx={{ flexGrow: 1 }}>
                  ...
                  <Box sx={{ flex: 1 }}>
                    ...
                    >
                      ...
                      <Select
                        ...
                        onChange={(e) =>
                          handleInputChange("spa", e.target.value)
                        }
                        sx={{ fontSize: "1.1rem" }}
                  ...
                  <Box sx={{ flex: 1 }}>
                    ...
                    >
                      <DialogContent sx={{ p: 4 }}>
                        ...
                        {Object.entries(filteredTimes).map(
                          ([period, times]) => (
          ...
          <Container>
            ...
            {isMobile && (
              <Box textAlign="center">
                ...
                >
                  {showAllAbout
                    ? t("home.about.viewLess")
                    : t("home.about.viewAll")}
                </Button>
              </Box>
            )}
          </Container>
        ...
        <Box sx={{ py: 4, bgcolor: "grey.50" }}>
          <Container
            maxWidth={false}
            sx={{ maxWidth: "1250px", mx: "auto", px: { xs: 2, md: 4 } }}
          >
                    ...
                    >
                      ...
                      >
                        <li>
                          ...
                          >
                            <strong>
                              {t("home.featuredProducts.duration")}
                            </strong>{" "}
                            {service.durationMinutes}{" "}
                            {t("home.featuredProducts.minutes")}
                          </Typography>
                        </li>
                        ...
                        <li>
                          ...
                          >
                            <strong>{t("home.featuredProducts.price")}</strong>{" "}
                            {service.price}
                          </Typography>
                        </li>
